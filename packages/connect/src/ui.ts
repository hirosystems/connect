import { WebBTCProvider, getInstalledProviders, getSelectedProvider } from '@stacks/connect-ui';
...
// todo: look into chrome extension url assets
// todo: flatten urls?
...
function wrapConnectCall<F extends (o: ActionOptions, p?: StacksProvider) => any>(action: F) {
...
export const uiSignMessage = wrapConnectCall(signMessage);
